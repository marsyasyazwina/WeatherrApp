package com.marsya.idn.weatherrapp
...
import com.marsya.idn.weatherrapp.Constants.API_KEY
import com.marsya.idn.weatherrapp.Constants.METRIC_UNIT
import com.marsya.idn.weatherrapp.Constants.isNetworkAvailable
import com.marsya.idn.weatherrapp.models.WeatherResponse
import com.marsya.idn.weatherrapp.network.WeatherConfig
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getLocationWeatherDetails(latitude: Double, longitude: Double) {
        if (Constants.isNetworkAvailable(this)) {
            ...
            //melakukan request
            val enqueue = client.enqueue(object : Callback<WeatherResponse> {
